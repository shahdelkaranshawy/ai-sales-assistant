...
The production app adds FastAPI routers, real `GraphDBInterface`, SQLAlchemy repos, fifteen+ tools, and full-length domain prompts; see `docs/knowledge-graph.md` and `architecture/knowledge-graph-schema.svg` for the full design.
